                        ...
                        <div className="services-details__left">
                            ...
                            <div className="services-details__content">
                                <h3 className="services-details__title-1">
                                    Comprehensive Design and Branding Solutions
                                </h3>

                                <div className="services-details__shape-1"></div>

                                <p className="services-details__text-1">
                                    Our design and branding services shape how your business is seen, remembered, and
                                    trusted. We create brand systems that combine strong visuals with strategic messaging
                                    so your identity remains consistent across every customer touchpoint.
                                </p>

                                <h3 className="services-details__title-2">Services Core Features</h3>
                                <p className="services-details__text-2">
                                    We begin with discovery, positioning, and visual direction before building your brand
                                    toolkit. From logo and typography to brand voice and collateral, we craft assets that
                                    support both recognition and conversion.
                                </p>

                                {/* FEATURES LIST */}
                                <div className="services-details__points-box">
                                    <ul className="services-details__points-list list-unstyled">
                                        <li><span className="icon-check"></span> Brand Positioning Framework</li>
                                        <li><span className="icon-check"></span> Logo and Identity Design</li>
                                        <li><span className="icon-check"></span> Visual Language Development</li>
                                    </ul>

                                    <ul className="services-details__points-list list-unstyled">
                                        <li><span className="icon-check"></span> Brand Messaging and Tone</li>
                                        <li><span className="icon-check"></span> Creative Asset Production</li>
                                        <li><span className="icon-check"></span> Brand Consistency Guidelines</li>
                                    </ul>
                                </div>
                                ...
                                <div className="services-details__single-service-box">
                                    <div className="row">
                                        {[{ iconClass: "icon-define", text: "Brand Discovery" },
                                        { iconClass: "icon-seminar", text: "Identity Direction" },
                                        { iconClass: "icon-solution", text: "Creative Production" },
                                        { iconClass: "icon-software-development", text: "Brand Implementation" }].map((item, i) => (
