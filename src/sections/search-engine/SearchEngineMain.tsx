                        ...
                        <div className="services-details__left">
                            <div className="services-details__img">
                                <div className="services-details__single-service">
                                    <div className="services-details__single-icon">
                                        <span className="icon-cyber-threat"></span>
                                    </div>
                            ...
                            <div className="services-details__content">
                                ...
                                <p className="services-details__text-1">
                                    Our SEO services are focused on improving visibility, ranking, and qualified traffic.
                                    We optimize your technical foundation, on-page relevance, and content strategy to help
                                    your business appear in front of the right audience at the right time.
                                </p>

                                <h3 className="services-details__title-2">Services Core Features</h3>
                                <p className="services-details__text-2">
                                    We audit your current site, identify ranking gaps, and build an SEO roadmap aligned
                                    with your goals. Our team covers keyword research, technical fixes, and content
                                    optimization to drive sustainable organic growth.
                                </p>

                                {/* FEATURES LIST */}
                                <div className="services-details__points-box">
                                    <ul className="services-details__points-list list-unstyled">
                                        <li><span className="icon-check"></span> Technical SEO Audits</li>
                                        <li><span className="icon-check"></span> Keyword Opportunity Mapping</li>
                                        <li><span className="icon-check"></span> On-Page Optimization</li>
                                    </ul>

                                    <ul className="services-details__points-list list-unstyled">
                                        <li><span className="icon-check"></span> Internal Link Structuring</li>
                                        <li><span className="icon-check"></span> Content Brief Development</li>
                                        <li><span className="icon-check"></span> Performance Tracking</li>
                                    </ul>
                                </div>
                                ...
                                <div className="services-details__single-service-box">
                                    <div className="row">
                                        {[{ iconClass: "icon-define", text: "Search Intent Analysis" },
                                        { iconClass: "icon-seminar", text: "SERP Competitor Review" },
                                        { iconClass: "icon-solution", text: "On-Site SEO Enhancements" },
                                        { iconClass: "icon-software-development", text: "Content Optimization Plan" }].map((item, i) => (
