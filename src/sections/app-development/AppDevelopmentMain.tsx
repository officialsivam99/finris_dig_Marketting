                        ...
                        <div className="services-details__left">
                            ...
                            <div className="services-details__content">
                                ...
                                <p className="services-details__text-1">
                                    Our app development services focus on building reliable mobile and web applications
                                    that solve real business problems. We combine product thinking, clean architecture, and
                                    iterative delivery to ship high-quality apps faster.
                                </p>

                                <h3 className="services-details__title-2">Services Core Features</h3>
                                <p className="services-details__text-2">
                                    We define technical scope, user journeys, and delivery milestones upfront. Our team
                                    handles UI engineering, backend APIs, testing, and release workflows to deliver apps
                                    that are maintainable, secure, and ready to scale.
                                </p>

                                {/* FEATURES LIST */}
                                <div className="services-details__points-box">
                                    <ul className="services-details__points-list list-unstyled">
                                        <li><span className="icon-check"></span> Product Requirement Planning</li>
                                        <li><span className="icon-check"></span> Cross-Platform Development</li>
                                        <li><span className="icon-check"></span> Backend API Integration</li>
                                    </ul>

                                    <ul className="services-details__points-list list-unstyled">
                                        <li><span className="icon-check"></span> QA and Performance Testing</li>
                                        <li><span className="icon-check"></span> Release and Deployment Support</li>
                                        <li><span className="icon-check"></span> Ongoing Feature Enhancements</li>
                                    </ul>
                                </div>
                                ...
                                <div className="services-details__single-service-box">
                                    <div className="row">
                                        {[{ iconClass: "icon-define", text: "Product Scoping" },
                                        { iconClass: "icon-seminar", text: "Architecture Design" },
                                        { iconClass: "icon-solution", text: "Agile Build Cycles" },
                                        { iconClass: "icon-software-development", text: "Release Management" }].map((item, i) => (
